...
<p>&nbsp;</p>
<p>&nbsp;</p>
<h1 align="center" style="font-size:30px"><strong>About Us </strong></h1>
<h1 align="center" style="font-size:30px"><br />
</h1>
<div align="center">
  <table width="972" height="61" border="0">
    <tr>
      <td width="966" align="left" valign="top"><p class="style3">Name of our site says a lot about us... </p>
        <p class="style3">Yes, we are VITians.</p>
        <br>
        <p class="style2">Credits:</p>
        <br>
        <p class="style3">Web Designing &amp; programming Team:</p>
        <p class="style3">Raj &amp; Sam.</p>
        <span class="style3"><br>
        </span>
        <p class="style3">Management Team:</p>
        <p class="style3">Raj &amp; Sam.</p>
        <p>&nbsp; </p>
        <p class="style3">Creative Team:</p>
        <p><span class="style3">Yanku</span>.<br />
          <br />      
        </p></td>
    </tr>
  </table>
