...
(function($) {
	...
	$.fn.smartCart = function(options) {
		...
		var defaults = {
          ...
          // Text Labels
		  itemTimeSelectorPrefix: '#prod_time',
		  itemDpSelectorPrefix: '#prod_dp',
    			removeLabel: 'X',		// text for the "remove" link
	  ...
	  var subTotal=0;
          ...
          var prodId = lastAddedItemId = $(this).attr('rel');
				...
				var prodTime = $(options.itemTimeSelectorPrefix+prodId + " option:selected").text();
				var prodDp = $(options.itemDpSelectorPrefix+prodId + " option:selected").text();
				
  				var prodQty  = $(options.itemQuantitySelectorPrefix+prodId + " option:selected").text();
				prodQty = parseInt(prodQty,10);
  				
				setHighlight(options.addedLabel);
  				var $option = $("<option></option>").text(prodName).val(prodId+"|"+prodQty+"|"+prodTime+"|"+prodDp).attr("selected", true); 
          ...
          if(listItems.length>1){
            ...
            scItemList.children("option").each(function(n) {
                var tmpOpt = $(this);
                  ...
                  var itemText = "<table><tr><td width='69' align='center'>"+tmpOpt.html()+"</td><td width='21' align='center'>"+itemQty+
                                 "</td><td width='79' align='center'>"+itemTime+"</td><td width='102' align='center'>"+itemDp+"</td><td width='99' align='center'>"+itemTotal+"</td>"+"</td><td width='15' align='center'></td></tr></table>";
